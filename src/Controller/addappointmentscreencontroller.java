...
public class addappointmentscreencontroller implements Initializable {
    ...
    @FXML
    void onActionApptIdTxtFld(ActionEvent event) {
    ...
    @FXML
    void onActionCustIdDropDownBox(ActionEvent event) {
    ...
    /**
     * This method will convert time to eastern standard time.
     *
     * @param timeConvert timeConvert
     * @return will return time in EST
     */
        ...
        if (checkForInputAndTimeValidation) {
            ...
            try {
                ...
                if (inputCheckWasVerify) {
                    ...
                    Alert alertUserMsg = new Alert(Alert.AlertType.CONFIRMATION, "The appointment was added successfully.");
                    ...
                    Alert alert = new Alert(Alert.AlertType.ERROR, "The appointment was not added. Please try again.");
